...
\begin{figure}[ht]
	\centering
	\subfloat{\includegraphics[width = 0.45\textwidth]{Figures/FXOS_Orientation.png}\label{fig:FXOS_Orientation}}
	\hfill
	\subfloat{\includegraphics[width = 0.45\textwidth]{Figures/FXAS_Orientation.png}\label{fig:FXAS_Orientation}}
