...
V této kapitole bude popsán stav problematiky automatického řízení a pohybových senzorů. Konkretně bude popsaná práce \uv{Krokoměr s mikropočítačem ARM} Filipa Šiguta, který používá ve své práce akcelerometry. Následné budou popsaný práci \uv{Autonomní řízení auta - optimalizace detekce dráhy} i \uv{Mechanizmy řízení robotického auta NXP (FREESCALE)}, které popisuje autonomní řízení na základe řádkové kamery a senzorů. Autory jsou Vojtěch Ihn a Richard Zvonek.
