...
bool Region::IsBlack() { return Color == Image::COLOR_BLACK; }
bool Region::IsWhite() { return Color == Image::COLOR_WHITE; }
...
bool Region::operator!=(const Region &rhs) { return !(*this == rhs); }
