/*
 * Code from https://www.arduino.cc/reference/en/libraries/pid/
 */
...
#define P_ON_E 1
    ...
    // **************************************************************************
    PID(Shared::PIDData &pidData, int POn, int ControllerDirection);
...
private:
    ...
    double *mySetpoint;  //   PID, freeing the user from having to constantly
                         //   tell us what these values are.  with pointers
                         //   we'll just know.
