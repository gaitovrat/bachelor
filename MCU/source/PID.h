...
class PID {
  public:
    ...
    PID(double *Input, double *Output, double *Setpoint, double Kp, double Ki,
        double Kd, int POn,
        int ControllerDirection); //   Setpoint.  Initial tuning parameters are
                                  //   also set here.
    //   (overload for specifying proportional mode)

    PID(double *Input, double *Output, double *Setpoint, double Kp, double Ki,
        double Kd, int ControllerDirection); //   Setpoint.  Initial tuning
    ...
    void SetOutputLimits(double, double); // * clamps the output to a specific
  ...
  private:
    ...
    double
        *myOutput; //   This creates a hard link between the variables and the
    double *
