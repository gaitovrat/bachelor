...
FXAS21002::FXAS21002(FXAS21002::Range range)
    : BaseSensor(I2C0), m_eviceAddress(0x21), m_range(range) {}
...
uint8_t FXAS21002::DeviceAddress() const { return this->m_eviceAddress; }
