...
void HW_TFC_MOTOR_OnOff( int onoff )
{
	...
	{
		HW_TFC_MOTOR_SetPWM( 0, 0 );
		GPIO_ClearPinsOutput( HW_TFC_MOTOR_GPIO_SIG, 1 << HW_TFC_MOTOR_PIN_ENABLE );
...
static inline void HW_TFC_CAMERA_CLK_Set( int level )
{
	if ( level )
		...
		GPIO_ClearPinsOutput( HW_TFC_CAMERA_GPIO_SIG, 1 << HW_TFC_CAMERA_PIN_CLK );
}
