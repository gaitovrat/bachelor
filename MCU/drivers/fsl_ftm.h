...
typedef struct _ftm_chnl_pwm_signal_param {
    ftm_chnl_t chnlNumber;        /*!< The channel/channel pair number.
                                       In combined mode, this represents the channel
                                     pair number. */
    ...
    uint8_t
        firstEdgeDelayPercent; /*!< Used only in kFTM_AsymmetricalCombinedPwm
                                  mode to generate an asymmetrical PWM.
                                    Specifies the delay to the first edge in a
                                  PWM period. If unsure leave as 0; Should be
                                  specified as a percentage of the PWM period */
    bool enableComplementary;  /*!< Used only in combined PWM mode.
                                    true: The combined channels output
                                  complementary signals;  false: The combined
                                  channels output same signals; */
    bool enableDeadtime;       /*!< Used only in combined PWM mode with enable
                                  complementary.       true: The deadtime insertion in
                                  this       pair of channels is enabled;       false:
                                  The       deadtime       insertion in this pair of
...
typedef struct _ftm_chnl_pwm_config_param {
    ftm_chnl_t chnlNumber;        /*!< The channel/channel pair number.
                                     ...
                                     pair number. */
    ftm_pwm_level_select_t level; /*!< PWM output active level select. */
    uint16_t dutyValue; /*!< PWM pulse width, the uint of this value is timer
                           ticks. */
    uint16_t
        firstEdgeValue; /*!< Used only in kFTM_AsymmetricalCombinedPwm mode to
                           generate an asymmetrical PWM. Specifies the delay to
                           the first edge in a PWM period. If unsure leave as 0,
                           uint of this value is timer ticks. */
    bool enableComplementary; /*!< Used only in combined PWM mode.
                                   true: The combined channels output
                                 complementary signals; false: The combined
                                 channels output same signals; */
...
typedef enum _ftm_output_compare_mode {
    kFTM_NoOutputSignal =
        (1U << FTM_CnSC_MSA_SHIFT), /*!< No channel output when counter reaches
                                       CnV  */
    kFTM_ToggleOnMatch = ((1U << FTM_CnSC_MSA_SHIFT) |
                          (1U << FTM_CnSC_ELSA_SHIFT)), /*!< Toggle output */
    kFTM_ClearOnMatch = ((1U << FTM_CnSC_MSA_SHIFT) |
                         (2U << FTM_CnSC_ELSA_SHIFT)), /*!< Clear output */
    kFTM_SetOnMatch = ((1U << FTM_CnSC_MSA_SHIFT) |
                       (3U << FTM_CnSC_ELSA_SHIFT)) /*!< Set output */
} ftm_output_compare_mode_t;

/*! @brief FlexTimer input capture edge */
typedef enum _ftm_input_capture_edge {
    kFTM_RisingEdge =
        (1U << FTM_CnSC_ELSA_SHIFT), /*!< Capture on rising edge only*/
    kFTM_FallingEdge =
        (2U << FTM_CnSC_ELSA_SHIFT), /*!< Capture on falling edge only*/
    kFTM_RiseAndFallEdge =
        (3U << FTM_CnSC_ELSA_SHIFT) /*!< Capture on rising or falling edge */
...
typedef struct _ftm_dual_edge_capture_param {
    ...
    ftm_input_capture_edge_t
        currChanEdgeMode; /*!< Input capture edge select for channel n */
    ftm_input_capture_edge_t
        nextChanEdgeMode; /*!< Input capture edge select for channel n+1 */
...
typedef struct _ftm_phase_param {
    bool enablePhaseFilter;  /*!< True: enable phase filter; false: disable
                                filter */
    uint32_t phaseFilterVal; /*!< Filter value, used only if phase filter is
                                enabled */
...
typedef struct _ftm_fault_param {
    bool enableFaultInput; /*!< True: Fault input is enabled; false: Fault input
                              is disabled */
    bool faultLevel; /*!< True: Fault polarity is active low; in other words,
                        '0' indicates a fault; False: Fault polarity is active
                        high */
...
typedef enum _ftm_bdm_mode {
    kFTM_BdmMode_0 = 0U,
    /*!< FTM counter stopped, CH(n)F bit can be set, FTM channels in functional
    ...
    /*!< FTM counter stopped, CH(n)F bit is not set, FTM channels outputs are
       forced to their safe value , writes to MOD,CNTIN and C(n)V registers
       bypass the register buffers */
    kFTM_BdmMode_2,
    /*!< FTM counter stopped, CH(n)F bit is not set, FTM channels outputs are
       frozen when chip enters in BDM mode, writes to MOD,CNTIN and C(n)V
       registers bypass the register buffers */
    kFTM_BdmMode_3
    /*!< FTM counter in functional mode, CH(n)F bit can be set, FTM channels in
       functional mode, writes to MOD,CNTIN and C(n)V registers is in fully
       functional mode */
} ftm_bdm_mode_t;
...
typedef enum _ftm_fault_mode {
    ...
    kFTM_Fault_AllChnlsMan,  /*!< Enabled for all channels with manual fault
                                clearing */
    kFTM_Fault_AllChnlsAuto  /*!< Enabled for all channels with automatic fault
                                clearing */
} ftm_fault_mode_t;
...
typedef enum _ftm_external_trigger {
    kFTM_Chnl0Trigger =
        (1U << 4), /*!< Generate trigger when counter equals chnl 0 CnV reg */
    kFTM_Chnl1Trigger =
        (1U << 5), /*!< Generate trigger when counter equals chnl 1 CnV reg */
    kFTM_Chnl2Trigger =
        (1U << 0), /*!< Generate trigger when counter equals chnl 2 CnV reg */
    kFTM_Chnl3Trigger =
        (1U << 1), /*!< Generate trigger when counter equals chnl 3 CnV reg */
    kFTM_Chnl4Trigger =
        (1U << 2), /*!< Generate trigger when counter equals chnl 4 CnV reg */
    kFTM_Chnl5Trigger =
        (1U << 3), /*!< Generate trigger when counter equals chnl 5 CnV reg */
#if defined(FSL_FEATURE_FTM_HAS_CHANNEL6_TRIGGER) &&                           \
    (FSL_FEATURE_FTM_HAS_CHANNEL6_TRIGGER)
    kFTM_Chnl6Trigger =
        (1U << 8), /*!< Available on certain SoC's, generate trigger when
                      counter equals chnl 6 CnV reg */
#endif
#if defined(FSL_FEATURE_FTM_HAS_CHANNEL7_TRIGGER) &&                           \
    (FSL_FEATURE_FTM_HAS_CHANNEL7_TRIGGER)
    kFTM_Chnl7Trigger =
        (1U << 9), /*!< Available on certain SoC's, generate trigger when
                      counter equals chnl 7 CnV reg */
#endif
    kFTM_InitTrigger =
        (1U << 6), /*!< Generate Trigger when counter is updated with CNTIN */
    ...
    kFTM_ReloadInitTrigger =
        (1U << 7) /*!< Available on certain SoC's, trigger on reload point */
#endif
...
typedef enum _ftm_pwm_sync_method {
    kFTM_SoftwareTrigger =
        FTM_SYNC_SWSYNC_MASK, /*!< Software triggers PWM sync */
    kFTM_HardwareTrigger_0 =
        FTM_SYNC_TRIG0_MASK, /*!< Hardware trigger 0 causes PWM sync */
    kFTM_HardwareTrigger_1 =
        FTM_SYNC_TRIG1_MASK, /*!< Hardware trigger 1 causes PWM sync */
    kFTM_HardwareTrigger_2 =
        FTM_SYNC_TRIG2_MASK /*!< Hardware trigger 2 causes PWM sync */
...
typedef enum _ftm_reload_point {
    kFTM_Chnl0Match =
        (1U << 0), /*!< Channel 0 match included as a reload point */
    kFTM_Chnl1Match =
        (1U << 1), /*!< Channel 1 match included as a reload point */
    kFTM_Chnl2Match =
        (1U << 2), /*!< Channel 2 match included as a reload point */
    kFTM_Chnl3Match =
        (1U << 3), /*!< Channel 3 match included as a reload point */
    kFTM_Chnl4Match =
        (1U << 4), /*!< Channel 4 match included as a reload point */
    kFTM_Chnl5Match =
        (1U << 5), /*!< Channel 5 match included as a reload point */
    kFTM_Chnl6Match =
        (1U << 6), /*!< Channel 6 match included as a reload point */
    kFTM_Chnl7Match =
        (1U << 7),           /*!< Channel 7 match included as a reload point */
    kFTM_CntMax = (1U << 8), /*!< Use in up-down count mode only, reload when
                                counter reaches the maximum value */
    kFTM_CntMin = (1U << 9), /*!< Use in up-down count mode only, reload when
                                counter reaches the minimum value */
...
typedef enum _ftm_interrupt_enable {
    ...
    kFTM_TimeOverflowInterruptEnable =
        (1U << 9), /*!< Time overflow interrupt */
    kFTM_ReloadInterruptEnable =
        (1U << 10) /*!< Reload interrupt; Available only on certain SoC's */
...
typedef enum _ftm_status_flags {
    ...
    kFTM_ReloadFlag =
        (1U << 11) /*!< Reload Flag; Available only on certain SoC's */
} ftm_status_flags_t;
...
enum {
    kFTM_QuadDecoderCountingIncreaseFlag =
        FTM_QDCTRL_QUADIR_MASK, /*!< Counting direction is increasing (FTM
                                   counter increment), or the direction is
                                   decreasing. */
    kFTM_QuadDecoderCountingOverflowOnTopFlag =
        FTM_QDCTRL_TOFDIR_MASK, /*!< Indicates if the TOF bit was set on the top
 ...
 * FTM_GetDefaultConfig() function and pass a pointer to the configuration
 * structure instance.
 *
...
typedef struct _ftm_config {
    ...
    uint32_t pwmSyncMode; /*!< Synchronization methods to use to update buffered
                             registers; Multiple update modes can be used by
                             providing an OR'ed list of options available in
                             enumeration ::ftm_pwm_sync_method_t. */
    uint32_t reloadPoints;      /*!< FTM reload points; When using this, the PWM
                                     synchronization is not required. Multiple reload
                                   points can be used by providing      an OR'ed list
                                   of      options available in      enumeration
                                   ::ftm_reload_point_t. */
    ftm_fault_mode_t faultMode; /*!< FTM fault control mode */
    uint8_t faultFilterValue;   /*!< Fault input filter value */
    ftm_deadtime_prescale_t
        deadTimePrescale;   /*!< The dead time prescalar value */
    uint32_t deadTimeValue; /*!< The dead time value
                                 deadTimeValue's available range is 0-1023 when
                               register has DTVALEX, otherwise its available
                               range is 0-63. */
    uint32_t
        extTriggers; /*!< External triggers to enable. Multiple trigger sources
                        can be enabled by providing an OR'ed list of options
                        available in enumeration ::ftm_external_trigger_t. */
    uint8_t chnlInitState; /*!< Defines the initialization value of the channels
                              in OUTINT register */
    uint8_t chnlPolarity;  /*!< Defines the output polarity of the channels in
                              POL register */
 ...
 * operation.
 *
 * @note This API should be called at the beginning of the application which is
 * using the FTM driver. If the FTM instance has only TPM features, please use
 * the TPM driver.
 *
 ...
 *
 * param base                FTM peripheral base address
 * param counterPeriod_Hz    The desired frequency in Hz which corresponding to
 * the time when the counter reaches the mod value param srcClock_Hz         FTM
 * counter clock in Hz
 *
 * return Calculated clock prescaler value, see @ref ftm_clock_prescale_t.
 */
static inline ftm_clock_prescale_t
FTM_CalculateCounterClkDiv(FTM_Type *base, uint32_t counterPeriod_Hz,
 ...
 *
 * Call this function to configure the PWM signal period, mode, duty cycle, and
 * edge. Use this function to configure all FTM channels that are used to output
 * a PWM signal.
 *
 * @param base        FTM peripheral base address
...
status_t FTM_SetupPwm(FTM_Type *base,
                      ...
                      uint8_t numOfChnls, ftm_pwm_mode_t mode,
 ...
 * this represents the channel pair number
 ...
 * to 100 0=inactive signal(0% duty cycle)... 100=active signal (100% duty
 * cycle)
 * @return kStatus_Success if the PWM update was successful
 *         kStatus_Error on failure
 */
status_t FTM_UpdatePwmDutycycle(FTM_Type *base, ftm_chnl_t chnlNumber,
 ...
 * @param level      The level to be set to the ELSnB:ELSnA field; Valid values
 * are 00, 01, 10, 11. See the Kinetis SoC reference manual for details about
 * this field.
 */
 ...
 *
 * Call this function to configure the PWM signal mode, duty cycle in ticks, and
 * edge. Use this function to configure all FTM channels that are used to output
 * a PWM signal. Please note that: This API is similar with FTM_SetupPwm() API,
 * but will not set the timer period, and this API will set channel match value
 * in timer ticks, not period percent.
 *
 * @param base        FTM peripheral base address
 * @param chnlParams  Array of PWM channel parameters to configure the
 * channel(s)
 ...
 * the FTM counter is captured into the CnV register. The user has to read the
 * CnV register separately to get this value. The filter function is disabled if
 * the filterVal argument passed in is 0. The filter function is available only
 * for channels 0, 1, 2, 3.
 *
 * @param base        FTM peripheral base address
 * @param chnlNumber  The channel number
 * @param captureMode Specifies which edge to capture
 * @param filterValue Filter value, specify 0 to disable filter. Available only
 * for channels 0-3.
 */
 ...
 * written into CnV reg), the channel output is changed based on what is
 * specified in the compareMode argument.
 *
 * @param base         FTM peripheral base address
 * @param chnlNumber   The channel number
 ...
 * capture edge for the channel pair and the capture mode (one-shot or
 * continuous) is specified in the parameter argument. The filter function is
 * disabled if the filterVal argument passed is zero. The filter function is
 * available only on channels 0 and 2. The user has to read the channel CnV
 * registers separately to get the capture values.
 *
 * @param base           FTM peripheral base address
 ...
 */
void FTM_SetupDualEdgeCapture(FTM_Type *base, ftm_chnl_t chnlPairNumber,
 ...
 *
 * Timers counts from 0 until it equals the count value set here. The count
 * value is written to the MOD register.
 *
 * @note
 * 1. This API allows the user to use the FTM module as a timer. Do not mix
 * usage of this API with FTM's PWM setup API's.
 * 2. Call the utility macros provided in the fsl_common.h to convert usec or
 * msec to ticks.
 *
 * @param base FTM peripheral base address
 * @param ticks A timer period in units of ticks, which should be equal or
 * greater than 1.
 */
 ...
 * a timer period.
 *
 * @note Call the utility macros provided in the fsl_common.h to convert ticks
 * to usec or msec.
 *
 * @param base FTM peripheral base address
 *
 ...
 *
 * This function returns the captured value of a FTM channel configured in input
 * capture or dual edge capture mode.
 *
 * @note Call the utility macros provided in the fsl_common.h to convert ticks
 * to usec or msec.
 *
 ...
 */
static inline uint32_t FTM_GetInputCaptureValue(FTM_Type *base,
 ...
 */
static inline void
FTM_SetSoftwareCtrlEnable(FTM_Type *base, ftm_chnl_t chnlNumber, bool value) {
    if (value) {
 ...
 */
static inline void FTM_SetSoftwareCtrlVal(FTM_Type *base, ftm_chnl_t chnlNumber,
                                          bool value) {
    if (value) {
        base->SWOCTRL |=
            (1UL << ((uint32_t)chnlNumber + FTM_SWOCTRL_CH0OCV_SHIFT));
    } else {
        base->SWOCTRL &=
            ~(1UL << ((uint32_t)chnlNumber + FTM_SWOCTRL_CH0OCV_SHIFT));
    }
 ...
 */
static inline void FTM_SetGlobalTimeBaseOutputEnable(FTM_Type *base,
                                                     bool enable) {
    if (enable) {
 ...
 *
 * To enable the PWM channel output call this function with val=true. For input
 * mode, call this function with val=false.
 *
 * @param base       FTM peripheral base address
 * @param chnlNumber Channel to be configured
 ...
 * input mode
 */
static inline void FTM_SetPwmOutputEnable(FTM_Type *base, ftm_chnl_t chnlNumber,
                                          bool value) {
    if (value) {
 ...
 */
static inline void FTM_SetFaultControlEnable(FTM_Type *base,
                                             ftm_chnl_t chnlPairNumber,
                                             bool value) {
    /* Fault input is not supported if the instance has only basic feature.*/
#if (defined(FSL_FEATURE_FTM_HAS_BASIC_FEATURE_ONLY_INSTANCE) &&               \
     FSL_FEATURE_FTM_HAS_BASIC_FEATURE_ONLY_INSTANCE)
    assert(0 == FSL_FEATURE_FTM_IS_BASIC_FEATURE_ONLY_INSTANCEn(base));
#endif
    if (value) {
        base->COMBINE |=
            (1UL << (FTM_COMBINE_FAULTEN0_SHIFT +
                     (FTM_COMBINE_COMBINE1_SHIFT * (uint32_t)chnlPairNumber)));
    } else {
        base->COMBINE &=
            ~(1UL << (FTM_COMBINE_FAULTEN0_SHIFT +
                      (FTM_COMBINE_COMBINE1_SHIFT * (uint32_t)chnlPairNumber)));
 ...
 * @param base           FTM peripheral base address
 * @param chnlPairNumber The FTM channel pair number; options are 0, 1, 2, 3
 * @param value          true: Insert dead time in this channel pair; false: No
 * dead time inserted
 */
static inline void
FTM_SetDeadTimeEnable(FTM_Type *base, ftm_chnl_t chnlPairNumber, bool value) {
    if (value) {
        base->COMBINE |=
            (1UL << (FTM_COMBINE_DTEN0_SHIFT +
                     (FTM_COMBINE_COMBINE1_SHIFT * (uint32_t)chnlPairNumber)));
    } else {
        base->COMBINE &=
            ~(1UL << (FTM_COMBINE_DTEN0_SHIFT +
 ...
 * complementary mode
 */
static inline void FTM_SetComplementaryEnable(FTM_Type *base,
                                              ftm_chnl_t chnlPairNumber,
                                              bool value) {
    if (value) {
        base->COMBINE |=
            (1UL << (FTM_COMBINE_COMP0_SHIFT +
                     (FTM_COMBINE_COMBINE1_SHIFT * (uint32_t)chnlPairNumber)));
    } else {
        base->COMBINE &=
            ~(1UL << (FTM_COMBINE_COMP0_SHIFT +
 ...
 */
static inline void FTM_SetInvertEnable(FTM_Type *base,
                                       ftm_chnl_t chnlPairNumber, bool value) {
    if (value) {
 ...
 *
 * The modulo values configure the minimum and maximum values that the Quad
 * decoder counter can reach. After the counter goes over, the counter value
 * goes to the other side and decrease/increase again.
 *
 * @param base FTM peripheral base address.
 ...
 */
static inline void FTM_SetQuadDecoderModuloValue(FTM_Type *base,
                                                 uint32_t startValue,
                                                 uint32_t overValue) {
 ...
 *
 * @param base   FTM peripheral base address
 * @param enable true: software trigger is selected, false: software trigger is
 * not selected
 */
 ...
 *
 * Note: CHnIE bit needs to be set when calling this API. The channel DMA
 * transfer request is generated and the channel interrupt is not generated if
 * (CHnF = 1) when DMA and CHnIE bits are set.
 *
 * @param base   FTM peripheral base address.
 * @param chnlNumber Channel to be configured
 * @param enable true to enable, false to disable
 */
static inline void FTM_EnableDmaTransfer(FTM_Type *base, ftm_chnl_t chnlNumber,
                                         bool enable) {
    if (enable) {
        /* Enable DMA transfer */
